...
image:https://img.shields.io/badge/doc-outskirtslabs-orange.svg[doc,link=https://docs.outskirtslabs.com/ol.sfv/0.2/]
...
image:https://ci.outskirtslabs.com/repos/github/outskirtslabs/sfv/badge.svg[alt=nixbot,link=https://ci.outskirtslabs.com/repos/github/outskirtslabs/sfv]
...
* Extensively tested (`2853 tests, 3225 assertions`)
...
----
;; deps.edn
{:deps {com.outskirtslabs/sfv {:mvn/version "0.2.0"}}}

;; Leiningen
[com.outskirtslabs/sfv "0.2.0"]
----
...
* https://docs.outskirtslabs.com/ol.sfv/0.2/[Docs]
* https://docs.outskirtslabs.com/ol.sfv/0.2/api[API Reference]
...
|`++{++:type :dstring :value "Grüße"}` |`String` (percent-decoded,
validated)
|===
